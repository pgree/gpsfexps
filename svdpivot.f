...
ccc        call prinf('in svdpivot2 before _vects, ncols=*',ncols,1)

ccc        call prin2('s*',s,10)
ccc        call prin2('sub*',suba,m)
ccc        call prin2('diag*',da,m)
ccc        call prinf('ncols*',ncols,1)
