...
c 
        ...
        implicit real *8 (a-h,o-z)
        save
        dimension z(2,1),z2(2,1),z3(2,1),z4(2,1),z5(2,1)
        character *1 title(1)
c 
        inumgr=1
c 
        call zquaplo0(iw,z,z2,z3,z4,z5,n,n2,n3,n4,n5,title,
     1         inumgr,itype1,itype2,itype3,itype4,itype5)
c 
        return
        end
c 
...
c
        ...
        subroutine zquaplot4(iw,z,n,itype1,z2,n2,itype2,
     1        z3,n3,itype3,z4,n4,itype4,title)
        implicit real *8 (a-h,o-z)
        save
        dimension z(2,1),z2(2,1),z3(2,1),z4(2,1),z5(2,1)
        character *1 title(1)
...
c
c
        subroutine zquaplot5(iw,z,n,itype1,z2,n2,itype2,
     1        z3,n3,itype3,z4,n4,itype4,z5,n5,itype5,title)
        implicit real *8 (a-h,o-z)
        save
        dimension z(2,1),z2(2,1),z3(2,1),z4(2,1),z5(2,1)
        character *1 title(1)
...
c
c
        subroutine zquaplo0(iw,z,z2,z3,z4,z5,n,n2,n3,n4,n5,
     1      title,inumgr,itype1,itype2,itype3,itype4,itype5)
        implicit real *8 (a-h,o-z)
        save
        dimension z(2,1),z2(2,1),z3(2,1),z4(2,1),z5(2,1)
        character *1 title(1),gn(2),file1(8),anum1(8),line(82),
...
c
        do 2330 i=1,n4
        if(z4(1,i) .lt. xmin) xmin=z4(1,i)
        if(z4(2,i) .lt. ymin) ymin=z4(2,i)
        if(z4(1,i) .gt. xmax) xmax=z4(1,i)
        if(z4(2,i) .gt. ymax) ymax=z4(2,i)
 2330 continue
c
        if(inumgr .eq. 4) goto 2345
c
        do 2340 i=1,n5
        if(z5(1,i) .lt. xmin) xmin=z5(1,i)
        if(z5(2,i) .lt. ymin) ymin=z5(2,i)
        if(z5(1,i) .gt. xmax) xmax=z5(1,i)
        if(z5(2,i) .gt. ymax) ymax=z5(2,i)
 2340 continue
c
 2345 continue
c 
...
c 
        ...
        open(unit=iun22,file=file8)
c 
        write(iun22,3000) (z4(1,i),z4(2,i),i=1,n4)
c 
        close(iun22)
c 
c       if the user so requested - write the instructions for the
...
c 
 3000 format(2x,e11.5,2x,e11.5)
c 
        write(iun22,3000) (z5(1,i),z5(2,i),i=1,n5)
c 
        close(iun22)
        close(iun)
c 
...
c 
        inumgr=1
c 
        call zquagrap0(iw,z,z2,z3,z4,z5,n,n2,n3,n4,n5,title,
     1          inumgr,itype1,itype2,itype3,itype4,itype5)
c 
        return
        end
...
c
c
        subroutine zquagraph4(iw,z,n,itype1,z2,n2,itype2,
     1      z3,n3,itype3,z4,n4,itype4,title)
        implicit real *8 (a-h,o-z)
        save
        dimension z(2,1),z2(2,1),z3(2,1),z4(2,1),z5(2,1)
...
c
c
        subroutine zquagraph5(iw,z,n,itype1,z2,n2,itype2,
     1      z3,n3,itype3,z4,n4,itype4,z5,n5,itype5,title)
        implicit real *8 (a-h,o-z)
        save
        dimension z(2,1),z2(2,1),z3(2,1),z4(2,1),z5(2,1)
...
c
c
        subroutine zquagrap0(iw,z,z2,z3,z4,z5,n,n2,n3,n4,n5,
     1      title,inumgr,itype1,itype2,itype3,itype4,itype5)
        implicit real *8 (a-h,o-z)
        save
        dimension z(2,1),z2(2,1),z3(2,1),z4(2,1),z5(2,1)
